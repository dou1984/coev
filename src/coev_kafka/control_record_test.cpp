...
TEST(ControlRecordTest, DecodingControlRecords)
{
    ...
    PacketDecoder keyDecoder(abortTxCtrlRecKey);
    PacketDecoder valueDecoder(abortTxCtrlRecValue);
    ...
    PacketDecoder keyDecoderCommit(commitTxCtrlRecKey);
    PacketDecoder valueDecoderCommit(commitTxCtrlRecValue);
    ...
    PacketDecoder keyDecoderUnknown(unknownCtrlRecKey);
    PacketDecoder valueDecoderUnknown(unknownCtrlRecValue);
...
TEST(ControlRecordTest, EncodingControlRecords)
{
    ...
    PacketEncoder keyPrepEnc(PacketEncoder::PREP);
    PacketEncoder valuePrepEnc(PacketEncoder::PREP);
    ...
    PacketEncoder keyEncoder(PacketEncoder::REAL, 1024);
    PacketEncoder valueEncoder(PacketEncoder::REAL, 1024);
    ...
    // First pass: calculate required size
    PacketEncoder commitKeyPrepEnc(PacketEncoder::PREP);
    PacketEncoder commitValuePrepEnc(PacketEncoder::PREP);
    ...
    // First pass: calculate required size
    PacketEncoder unknownKeyPrepEnc(PacketEncoder::PREP);
    PacketEncoder unknownValuePrepEnc(PacketEncoder::PREP);
...
TEST(ControlRecordTest, VersionHandling)
{
    ...
    PacketDecoder keyDecoder(keyEncoder.m_raw);
    PacketDecoder valueDecoder(valueEncoder.m_raw);
