...
namespace coev::kafka
{
    ...
    PartitionOffsetManager::PartitionOffsetManager(std::shared_ptr<OffsetManager> parent, const std::string &topic,
    ...
    awaitable<void> PartitionOffsetManager::errors(std::shared_ptr<ConsumerError> &err)
    {
