...
namespace coev::kafka
{
    ...
    awaitable<void> ConsumerGroupSession::hander_error(std::shared_ptr<PartitionOffsetManager> pom, const std::string &topic, int32_t partition)
    {
        co_return;
    }
    awaitable<int> ConsumerGroupSession::_release(bool withCleanup)
    {
        m_cancel();
    ...
    awaitable<void> ConsumerGroupSession::_consume(const std::string &topic, int32_t partition)
    {
        co_return;
    }

    awaitable<void> ConsumerGroupSession::_heartbeat_loop()
    {
