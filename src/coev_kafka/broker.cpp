...
namespace coev::kafka
{
    ...
    awaitable<int> Broker::Open(std::shared_ptr<Config> conf)
    {
        if (!conf)
        {
    ...
    awaitable<int> Broker::GetMetadata(std::shared_ptr<MetadataRequest> request, ResponsePromise<MetadataResponse> &response)
    {
        return SendAndReceive(request, response);
    }
    awaitable<int> Broker::GetConsumerMetadata(std::shared_ptr<ConsumerMetadataRequest> request, ResponsePromise<ConsumerMetadataResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::FindCoordinator(std::shared_ptr<FindCoordinatorRequest> request, ResponsePromise<FindCoordinatorResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::GetAvailableOffsets(std::shared_ptr<OffsetRequest> request, ResponsePromise<OffsetResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::Produce(std::shared_ptr<ProduceRequest> request, ResponsePromise<ProduceResponse> &response)
    {
    ...
    awaitable<int> Broker::Fetch(std::shared_ptr<FetchRequest> request, ResponsePromise<FetchResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::CommitOffset(std::shared_ptr<OffsetCommitRequest> request, ResponsePromise<OffsetCommitResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::FetchOffset(std::shared_ptr<OffsetFetchRequest> request, ResponsePromise<OffsetFetchResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::JoinGroup(std::shared_ptr<JoinGroupRequest> request, ResponsePromise<JoinGroupResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::SyncGroup(std::shared_ptr<SyncGroupRequest> request, ResponsePromise<SyncGroupResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::LeaveGroup(std::shared_ptr<LeaveGroupRequest> request, ResponsePromise<LeaveGroupResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::Heartbeat(std::shared_ptr<HeartbeatRequest> request, ResponsePromise<HeartbeatResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::ListGroups(std::shared_ptr<ListGroupsRequest> request, ResponsePromise<ListGroupsResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::DescribeGroups(std::shared_ptr<DescribeGroupsRequest> request, ResponsePromise<DescribeGroupsResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::ApiVersions(std::shared_ptr<ApiVersionsRequest> request, ResponsePromise<ApiVersionsResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::CreateTopics(std::shared_ptr<CreateTopicsRequest> request, ResponsePromise<CreateTopicsResponse> &response)
    {

        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::DeleteTopics(std::shared_ptr<DeleteTopicsRequest> request, ResponsePromise<DeleteTopicsResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::CreatePartitions(std::shared_ptr<CreatePartitionsRequest> request, ResponsePromise<CreatePartitionsResponse> &response)
    {

        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::AlterPartitionReassignments(std::shared_ptr<AlterPartitionReassignmentsRequest> request, ResponsePromise<AlterPartitionReassignmentsResponse> &response)
    {

        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::ListPartitionReassignments(std::shared_ptr<ListPartitionReassignmentsRequest> request, ResponsePromise<ListPartitionReassignmentsResponse> &response)
    {

        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::ElectLeaders(std::shared_ptr<ElectLeadersRequest> request, ResponsePromise<ElectLeadersResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::DeleteRecords(std::shared_ptr<DeleteRecordsRequest> request, ResponsePromise<DeleteRecordsResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::DescribeAcls(std::shared_ptr<DescribeAclsRequest> request, ResponsePromise<DescribeAclsResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::CreateAcls(std::shared_ptr<CreateAclsRequest> request, ResponsePromise<CreateAclsResponse> &response)
    {
    ...
    awaitable<int> Broker::DeleteAcls(std::shared_ptr<DeleteAclsRequest> request, ResponsePromise<DeleteAclsResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::InitProducerID(std::shared_ptr<InitProducerIDRequest> request, ResponsePromise<InitProducerIDResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::AddPartitionsToTxn(std::shared_ptr<AddPartitionsToTxnRequest> request, ResponsePromise<AddPartitionsToTxnResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::AddOffsetsToTxn(std::shared_ptr<AddOffsetsToTxnRequest> request, ResponsePromise<AddOffsetsToTxnResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::EndTxn(std::shared_ptr<EndTxnRequest> request, ResponsePromise<EndTxnResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::TxnOffsetCommit(std::shared_ptr<TxnOffsetCommitRequest> request, ResponsePromise<TxnOffsetCommitResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::DescribeConfigs(std::shared_ptr<DescribeConfigsRequest> request, ResponsePromise<DescribeConfigsResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::AlterConfigs(std::shared_ptr<AlterConfigsRequest> request, ResponsePromise<AlterConfigsResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::IncrementalAlterConfigs(std::shared_ptr<IncrementalAlterConfigsRequest> request, ResponsePromise<IncrementalAlterConfigsResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::DeleteGroups(std::shared_ptr<DeleteGroupsRequest> request, ResponsePromise<DeleteGroupsResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::DeleteOffsets(std::shared_ptr<DeleteOffsetsRequest> request, ResponsePromise<DeleteOffsetsResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::DescribeLogDirs(std::shared_ptr<DescribeLogDirsRequest> request, ResponsePromise<DescribeLogDirsResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::DescribeUserScramCredentials(std::shared_ptr<DescribeUserScramCredentialsRequest> req, ResponsePromise<DescribeUserScramCredentialsResponse> &res)
    {
        return SendAndReceive(req, res);
    }

    awaitable<int> Broker::AlterUserScramCredentials(std::shared_ptr<AlterUserScramCredentialsRequest> req, ResponsePromise<AlterUserScramCredentialsResponse> &res)
    {
        return SendAndReceive(req, res);
    }

    awaitable<int> Broker::DescribeClientQuotas(std::shared_ptr<DescribeClientQuotasRequest> request, ResponsePromise<DescribeClientQuotasResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::AlterClientQuotas(std::shared_ptr<AlterClientQuotasRequest> request, ResponsePromise<AlterClientQuotasResponse> &response)
    {
        return SendAndReceive(request, response);
    }

    awaitable<int> Broker::Ready()
    {
        if (m_conn == nullptr)
        {
            co_return INVALID;
    ...
    awaitable<int> Broker::ReadFull(std::string &buf, size_t n)
    {
    ...
    awaitable<int> Broker::Write(const std::string &buf)
    {
        assert(m_conn->IsOpened());
        return m_conn->Write(buf);
    }

    awaitable<int> Broker::AuthenticateViaSASLv0()
    {
    ...
    awaitable<int> Broker::AuthenticateViaSASLv1()
    {
        ...
        if (mechanism == "GSSAPI")
        {
            ...
            co_return co_await m_kerberos_authenticator->AuthorizeV2(
                shared_from_this(),
                [this](auto req, auto res) -> awaitable<int>
                {
    ...
    awaitable<int> Broker::SendAndReceiveKerberos()
    {
        m_kerberos_authenticator->m_config = m_conf->Net.SASL.GSSAPI;
        if (!m_kerberos_authenticator->m_new_kerberos_client_func)
        {
    ...
    awaitable<int> Broker::SendAndReceiveSASLHandshake(const std::string &saslType, int16_t version)
    {
    ...
    awaitable<int> Broker::SendAndReceiveSASLPlainAuthV0()
    {
        if (m_conf->Net.SASL.Handshake)
        {
    ...
    awaitable<int> Broker::SendAndReceiveSASLPlainAuthV1(AuthSendReceiver authSendReceiver)
    {
    ...
    awaitable<int> Broker::SendAndReceiveSASLSCRAMv0()
    {
    ...
    awaitable<int> Broker::SendAndReceiveSASLSCRAMv1(std::shared_ptr<SCRAMClient> scramClient, AuthSendReceiver authSendReceiver)
    {
    ...
    awaitable<int> Broker::SendAndReceiveApiVersions(int16_t v, ResponsePromise<ApiVersionsResponse> &promise)
    {
        int err = 0;
