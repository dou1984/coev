...
namespace coev::kafka
{
    ...
    std::function<std::chrono::milliseconds(int retries, int maxRetries)> NewExponentialBackoff(std::chrono::milliseconds backoff, std::chrono::milliseconds maxBackoff);
}