...
namespace coev::kafka
{
    ...
    awaitable<int> ConsumerGroupClaim::messages(std::shared_ptr<ConsumerMessage> &msg)
    {
        co_await m_messages.get(msg);
        co_return 0;
    }
    awaitable<int> ConsumerGroupClaim::wait_closed(std::shared_ptr<ConsumerError> &err)
    {
