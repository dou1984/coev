...
# 目的
 ...
 c++20协程库是高性能的协程库方案, 但是一直没有流行起来，这是因为c++20协程理解起来有难度，开发者需要对其底层逻辑非常清晰，才能写出一个完善的协程过程，完成一个工程需要封装多个协程类，大大增加了开发成本。因此本文提供了一套协程封装实现方法，封装是基于事件驱动的，将协程开发从其他代码中分离出来，开发人员可以开箱即用，非常容易上手，可以快速将现有程序转为协程程序。
